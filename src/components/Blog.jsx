...
const Blog = () => {
  ...
  useEffect(() => {
    axios.get('https://developer-insights-blog.onrender.com/api/posts/')
      .then(response => {
  ...
  const handleCreatePost = () => {
    ...
    axios.post('https://developer-insights-blog.onrender.com/api/posts/', { title, content })
      .then(response => {
  ...
  const handleDeletePost = (id) => {
    axios.delete(`https://developer-insights-blog.onrender.com/api/posts/${id}/`)
      .then(() => {
  ...
  const updatePost = (updatedPost) => {
    axios.put(`https://developer-insights-blog.onrender.com/api/posts/${updatedPost.id}/`, updatedPost)
      .then(response => {
